...
public abstract class Hilt_RegistrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RegistrationFragment() {
    super();
  }

  Hilt_RegistrationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegistrationFragment_GeneratedInjector) this.generatedComponent()).injectRegistrationFragment(UnsafeCasts.<RegistrationFragment>unsafeCast(this));
    }
  }
