...
public final class FragmentRegistrationBinding implements ViewBinding {
  ...
  private FragmentRegistrationBinding(@NonNull ScrollView rootView, @NonNull TextView btnLogin,
      @NonNull Button btnSignUp, @NonNull ProgressBar progressBar, @NonNull EditText txtEmail,
  ...
  public static FragmentRegistrationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegistrationBinding((ScrollView) rootView, btnLogin, btnSignUp,
          progressBar, txtEmail, txtError, txtPassword, txtUsername);
    }
